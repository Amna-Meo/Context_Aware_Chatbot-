...
- **Clear Response Indicators**: 
  - 📄 Green = Answer from documents
  - 🌐 Yellow = General knowledge response
...
2. **View Responses**: 
   - Green responses (📄) are based on your documents
   - Yellow responses (🌐) are general knowledge when documents don't contain the answer
3. **Follow-up Questions**: The chatbot maintains context for natural conversations
4. **Clear History**: Use the sidebar button to start a fresh conversation
...
├── data_prep.py           # Document processing pipeline
...
2. Review test output: `python test_setup.py`
3. Check the CLAUDE.md file for implementation details
